    ...
    <>
      ...
      >
        ...
        >
          ...
          <h2 className="ml-24 font-semibold" style={{ textAlign: "center" }}>
            {following}
          </h2>
        </div>
        ...
        >
          <p style={{ fontWeight: "200", fontSize: "15px" }} className="ml-14">
            Posts
          </p>
          <p style={{ fontWeight: "200", fontSize: "15px" }} className="ml-12">
            Followers
          </p>
          <p style={{ fontWeight: "200", fontSize: "15px" }} className="ml-12">
            Following
        ...
        <hr
          ...
          className="border-l-1 border-stone-700"
        />
        <div />
        <div />
        <Modal

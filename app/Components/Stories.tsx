...
export const Stories: React.FC<NotificationProps> = ({ isWhite }: NotificationProps) =>  {
  return (
    <div>
        <div >
     <h1 className='text-xl font-bold ml-7 mt-7'>Stories</h1>
     <div className='float-left ml-7 flex justify-center border-2 border-slate-400 border-dashed cursor-pointer' style={{ marginTop:'30px', height:'70px',width:'70px',backgroundColor:isWhite ? 'black' : '#DEDEDE',borderRadius:'100px 100px 100px 100px '}}>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="float-left w-6 h-6  mt-5">
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
    ...
    <div style={{backgroundColor:isWhite ? '#1A0033' : 'white',color:isWhite ? 'white' : 'black'}} className=' w-1/1 h-4 mt-28'>
     <p style={{fontSize:'12px'}}  className='float-left ml-8 '>Add Story</p>
     <p style={{fontSize:'12px'}}  className='float-left  ml-10'>cristiano</p>
     <p style={{fontSize:'12px'}}   className='float-left   ml-14 '>dq salmaan</p>
     <p style={{fontSize:'12px'}}   className='float-left   ml-9'>t.shelby</p>
     <p style={{fontSize:'12px'}}   className='float-left   ml-12'>Elon musk</p>
     <p style={{fontSize:'12px'}}   className='float-left  ml-12'>Tony stark</p>
     <p style={{fontSize:'12px'}}  className='float-left   ml-10'>alnassr</p>
      </div>

          ...
          {users.map((user: any) => (
            <div key={user._id}>
              <div className='w-[345px] h-14 mt-5'>
                ...
                <button
                  className={`ml-36 mt-3 px-5 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-opacity-50 ${followedUsers[user._id] ? 'bg-red-500 hover:bg-red-600 focus:ring-red-300' : 'bg-blue-500 hover:bg-blue-600 focus:ring-blue-300'}`}

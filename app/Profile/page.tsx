...
<p style={{marginLeft:'90px',marginTop:'-25px',color:'whitesmoke'}}>Messages</p>
...
<div className='float-left'  style={{marginLeft:'65px',marginTop:'40px',backgroundImage: 'url(\'https://cdn-icons-png.flaticon.com/512/149/149071.png\')', backgroundSize: 'cover', backgroundPosition: 'center' ,height:'150px',width:'150px',borderRadius:'100px 100px 100px 100px '}}></div>
{/* <Createpost/> */}
...
<div style={{height:'518px'}} className='mt-20 w-1/1'>
    ...
    <div key={index} style={{border:'2px solid black',backgroundImage: `url(${item.image})`, backgroundSize: 'cover', backgroundPosition: 'center'}} className=' float-left w-64 h-64 '>

          ...
          >
            <div
              ...
              style={{
                ...
                width: "45px",
                backgroundImage:
                  "url('https://car-logos.b-cdn.net/wp-content/uploads/2023/04/bmw-logo-2020-present-1024x742.webp')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "100px 100px 100px 100px ",
              }}
            ></div>
            <p style={{ padding: "25px", fontSize: "15px" }} className=" ml-12">
              bmwindia
            </p>
            <img
              style={{
            ...
            <div
              style={{
                ...
                height: "400px",
                backgroundImage:
                  "url('https://wallpapers.com/images/high/bmw-desktop-hd-v32oehek1rjeoowc.webp')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                marginTop: "40px",
                marginLeft: "25px",
            ...
            <div style={{ width: "550px" }} className="  h-14 ml-7 mt-2">
              <p className=" text-sm">
                Experience unparalleled luxury and performance with BMW, where
                innovation meets elegance on every journey.
              </p>
            </div>
            <div className="mt-2">
              <svg
              ...
              <h1 style={{ paddingTop: "5px" }} className="float-left  mr-96">
                454
              </h1>
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <div
              ...
              style={{
                ...
                width: "45px",
                backgroundImage:
                  "url('https://cdn.icon-icons.com/icons2/1834/PNG/512/iconfinderlandroverlogo4142330-115968_115913.png')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "100px 100px 100px 100px ",
              }}
            ...
            <div
              style={{
                ...
                height: "400px",
                backgroundImage:
                  "url('https://www.hdcarwallpapers.com/walls/land_rover_defender_110_country_pack_first_edition_2020_4k_2-HD.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                marginTop: "40px",
                marginLeft: "25px",
            ...
            <div style={{ width: "550px" }} className="  h-14 ml-7 mt-2">
              <p className=" text-sm">
                Embark on a visual journey with breathtaking travel photography
                capturing the essence of destinations around the globe
              </p>
            </div>
            <div className="mt-2">
              <svg
          ...
          >
            <div
              ...
              style={{
                ...
                width: "45px",
                backgroundImage:
                  "url('https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Flag_of_Saudi_Arabia.svg/640px-Flag_of_Saudi_Arabia.svg.png')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "100px 100px 100px 100px ",
              }}
            ...
            <div
              style={{
                ...
                height: "400px",
                backgroundImage:
                  "url('https://i.pinimg.com/736x/eb/8e/fe/eb8efecf8e90df1d429451b1afae0c13.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                marginTop: "40px",
                marginLeft: "25px",
            ...
            <div className="mt-2">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="float-left w-8 h-8 mr-1 ml-6 "
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="float-left w-8 h-8 mr-1 "
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
